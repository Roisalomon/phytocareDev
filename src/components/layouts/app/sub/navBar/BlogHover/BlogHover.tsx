...
import UIBlogHover from "../../../../../ui/elements/navBarUI/UIBlogHover";

interface BlogHoverProps {
  mobile?: boolean;
}

const BlogHover: React.FC<BlogHoverProps> = ({ mobile = false }) => {
  ...
  return (
    ...
    >
      ...
      {/* ✅ Dropdown compact */}
      <div
        className={`absolute left-1/2 top-full ml-[180%] -translate-x-1/2 w-[300px] bg-white shadow-xl rounded-xl p-5 z-50 transition-all duration-200
